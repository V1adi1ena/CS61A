...
def roll_dice(num_rolls, dice=six_sided):
    ...
    res = 1 if 1 in rolls else sum(rolls)
    return res
    # END PROBLEM 1
...
def boar_brawl(player_score, opponent_score):
    ...
    "*** YOUR CODE HERE ***"
    m = player_score%10
    n = opponent_score//10%10
    return 1 if abs(m-n)==0 else 3*abs(m-n)
    # END PROBLEM 2
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    return max(range(1, 11), key=lambda i: avg_roll(i, dice))
    # END PROBLEM 9
...
def final_strategy(score, opponent_score, dice=6):
    """Write a brief description of your final strategy.

    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    if sus_update(0, score, opponent_score)>=sus_update(dice, score, opponent_score):
        return 0
    return dice  # Remove this line once implemented.
    # END PROBLEM 12
